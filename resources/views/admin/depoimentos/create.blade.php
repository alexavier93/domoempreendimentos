                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.depoimentos.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nome" class="form-control" value="{{ old('name') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="empreendimento" class="form-control" value="{{ old('name') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="texto" class="form-control summernote" required>{{ old('text') }}</textarea>
                            </div>
                        </div>
