        ...
        <div class="col-xl-12 col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.depoimentos.update', ['depoimento' => $depoimento->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="empreendimento" class="form-control" value="{{ $depoimento->empreendimento }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <textarea name="texto" class="form-control summernote" required>{{ $depoimento->texto }}</textarea>
                            </div>
                        </div>
