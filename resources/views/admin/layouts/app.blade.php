...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Categorias -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.imoveis.index') }}"><i
                        class="fas fa-home"></i><span>Imóveis</span></a>
            </li>

            <!-- Nav Item - Categorias -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.categorias.index') }}"><i
                        class="fas fa-list-ul"></i><span>Categorias</span></a>
            </li>

            <!-- Nav Item - Diferenciais -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.diferenciais.index') }}"><i class="fas fa-list-ul"></i><span>Diferenciais</span></a>
            </li>
            

            <!-- Nav Item - Status -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.status.index') }}"><i
                        class="fas fa-list-ul"></i><span>Status</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.posts.index') }}"><i
                        class="far fa-file-alt"></i><span>Blog</span></a>
            </li>

            <!-- Nav Item - Blog -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.depoimentos.index') }}"><i
                        class="far fa-file-alt"></i><span>Depoimentos</span></a>
            </li>
